...
%% plot accuracy for R1 and R2choose as function of location bin
...
for ss = 1:length(u_subj)% loop through each subj
   ...
   % set(gca,'TickDir','out','XTick',[-180 0 180],'YTick',[-180 0 180]); 
    xlabel('R1 Error'); ylabel('Proportion of Choose');
...
for ss = 1:length(u_subj) % go through all the subjects
    ...
    xlim([0 5]);ylim([0 .5]);
    set(gca,'TickDir','out','XTick',[0 1 5],'YTick',[0 0.1 .5]);
    xlabel('R1 Error'); ylabel('Proportion of trials in R2 Choose');
end
...
for ss = 1:length(u_subj) % go through all the subjects
    ...
    xlim([0 5]);ylim([0 .5]);
    set(gca,'TickDir','out','XTick',[0 1 5],'YTick',[0 0.1 .5]);
    xlabel('R2 Cue Error'); ylabel('Proportion of trials in R2 Choose');
end
